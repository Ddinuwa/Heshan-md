...
global.location="embilipitiya,sri lanka."
...
global.userImages= process.env.USER_IMAGES|| "https://i.ibb.co/3m3rDC9V/44d9b390e137e0ac.jpg",
...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "true,94775786482";


//========================= [ AUTO SAVE & READ STATUS ] =========================\\
global.read_status = process.env.AUTO_READ_STATUS || "true"
global.save_status = process.env.AUTO_SAVE_STATUS || "false"
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "true,94775786482";
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "HESHAN-MD",
  packname: process.env.PACK_NAME || "♥️",
  botname : process.env.BOT_NAME  || "HESHAN-MD",
  ownername:process.env.OWNER_NAME|| "HESHAN-SD",
